...
public class GroupGoalsFragment extends Fragment implements SearchView.OnQueryTextListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new GroupGoalsAdapter(groupGoalsList);
...
//        recyclerView.addItemDecoration(new DividerItemDecoration(this, LinearLayoutManager.VERTICAL));
    ...
    private void prepareGroupGoalsData() {
        GroupGoals groupGoals = new GroupGoals("Buy 5 Hives", "23/5/2018", "500000");
        groupGoalsList.add(groupGoals);

        groupGoals = new GroupGoals("Buy seeds", "23/5/2018", "703000");
        groupGoalsList.add(groupGoals);
