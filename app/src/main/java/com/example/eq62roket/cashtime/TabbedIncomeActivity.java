...
//        });
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_tabbed_income, container, false);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    GroupIncomeFragment group = new GroupIncomeFragment();
                    return group;
                case 1:
                    MembersIncomeFragment members = new MembersIncomeFragment();
                    return members;
                default:
                    return null;
            }
